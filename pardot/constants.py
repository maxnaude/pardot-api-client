RESOURCE_OPERATIONS = {
    ...
    'customRedirect': {'query': [()], 'read': [('id', )]},
    'dynamicContent': {'query': [()], 'read': [('id', )]},
    'email': {
        'read': [('email', )],
        'send': [
    ...
    'emailClick': {'query': [('search_criteria', 'result_set_criteria')]},
    'emailTemplate': {'listOneToOne': [()], 'read': [('emailTemplateId', )]},
    'form': {'query': [()], 'read': [('id', )]},
    'lifecycleHistory': {'query': [()], 'read': [('id', )]},
    ...
    'tag': {'query': [()], 'read': [('id', )]},
    'tagObject': {'query': [()], 'read': [('id', )]},
    'user': {'query': [()], 'read': [('email', ), ('id', )]},
    'visit': {'query': [('visitor_ids', 'prospect_ids)')], 'read': [('id', )]},
    'visitor': {'assign': [('id', )], 'query': [()], 'read': [('id', )]},
    'visitorActivity': {
